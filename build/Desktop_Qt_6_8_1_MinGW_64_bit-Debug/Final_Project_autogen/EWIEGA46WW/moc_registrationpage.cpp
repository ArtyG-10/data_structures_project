...
static constexpr auto qt_meta_stringdata_ZN16RegistrationPageE = QtMocHelpers::stringData(
    "RegistrationPage",
...
Q_CONSTINIT static const uint qt_meta_data_ZN16RegistrationPageE[] = {
...
Q_CONSTINIT const QMetaObject RegistrationPage::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16RegistrationPageE.offsetsAndSizes,
    qt_meta_data_ZN16RegistrationPageE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16RegistrationPageE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<RegistrationPage, std::true_type>,
...
void *RegistrationPage::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16RegistrationPageE.stringdata0))
